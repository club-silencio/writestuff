...
//    document.getElementById('forceTouchCapability').innerHTML = forceTouchCapability;
    ...
    {
        pressure = ForceTouchData.touches[0].force;
...
//    if (ForceTouchData.touches[0].force > 0) {
//      pressure = ForceTouchData.touches[0].force;
//    }
...
SignaturePad.prototype._reset = function () {
  ...
  // Old last width equation
  // this._lastWidth = (this.minWidth + this.maxWidth) / 2;
  // New last width equation - JW
  this._lastWidth = Math.max((pressure * this.maxWidth),this.minWidth);
...
SignaturePad.prototype._calculateCurveWidths = function (curve) {
  ...
  // proper width calculation - JW
  var newWidth = Math.max((pressure * this.maxWidth),this.minWidth);
